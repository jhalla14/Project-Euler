...
public class Problem11 {
    ...
    private final static Integer[][] GRID = {{8,2,22,97,38,15,0,40,0,75,4,5,7,78,52,12,50,77,91,8},
                                             ...
                                             {21,36,23,9,75,0,76,44,20,45,35,14,0,6,33,97,34,31,33,95},
    ...
    public static Integer solve(){
        ...
        for (ArrayList<Integer> horizontalSet: rightSets){
            int product = 1;
        ...
        int verticalSetMax = 0;
        for (ArrayList<Integer> verticalSet: downSets){
            if (verticalSet != null) {
                int product = 1;
        ...
        System.out.println(verticalSetMax);

        int diagonalSetMax = 0;
        for (ArrayList<Integer> diagonalSet: diagonalSets){
            if (diagonalSet != null){
                int product = 1;
        ...
        System.out.println(diagonalSetMax);
